...
export const ComponentVariantSchema = z.object({
  name: z.string(),
  className: z.string(), // Tailwind classes only
...
export interface ModificationRequest {
  type: 'update-token' | 'add-component' | 'modify-component' | 'add-page' | 'update-page' | 'update-navigation'
  target: string // ID of what to modify
