# TaskFlow Demo & Tutorial Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Create a tutorial article with 15 steps covering all platform capabilities, with screenshot placeholders, ready for manual scenario execution.

**Architecture:** Single markdown article in `docs/case-studies/`. Each step: brief explanation → exact command → expected result → screenshot placeholder. The article doubles as a test plan — run through it sequentially to verify all features work and capture screenshots.

**Tech Stack:** Markdown, Coherent CLI

---

## Task 1: Write article — intro and setup (Steps 1-2)

**Files:**
- Create: `docs/case-studies/taskflow-tutorial.md`

**Step 1: Write the article header and Steps 1-2**
...
Open the file and scan for any markdown formatting issues.

**Step 3: Commit**

```bash
git add docs/case-studies/taskflow-tutorial.md
git commit -m "docs: add TaskFlow tutorial — intro and steps 1-2"
```

---

## Task 2: Write article — full generation (Steps 3-4)
...
```bash
git add docs/case-studies/taskflow-tutorial.md
git commit -m "docs: add TaskFlow tutorial — steps 3-4 (generation + review)"
```

---

## Task 3: Write article — design iteration (Steps 5-6)

**Files:**
- Modify: `docs/case-studies/taskflow-tutorial.md`

**Step 1: Append Steps 5-6**
...
```bash
git add docs/case-studies/taskflow-tutorial.md
git commit -m "docs: add TaskFlow tutorial — steps 5-6 (design iteration)"
```

---

## Task 4: Write article — shared component workflow (Steps 7-10)

**Files:**
- Modify: `docs/case-studies/taskflow-tutorial.md`

**Step 1: Append Steps 7-10**
...
```bash
git add docs/case-studies/taskflow-tutorial.md
git commit -m "docs: add TaskFlow tutorial — steps 7-10 (shared component workflow)"
```

---

## Task 5: Write article — undo and header (Steps 11-12)

**Files:**
- Modify: `docs/case-studies/taskflow-tutorial.md`

**Step 1: Append Steps 11-12**
...
```bash
git add docs/case-studies/taskflow-tutorial.md
git commit -m "docs: add TaskFlow tutorial — steps 11-12 (undo + header edit)"
```

---

## Task 6: Write article — quality and export (Steps 13-15)

**Files:**
- Modify: `docs/case-studies/taskflow-tutorial.md`

**Step 1: Append Steps 13-15**
...
```bash
git add docs/case-studies/taskflow-tutorial.md
git commit -m "docs: add TaskFlow tutorial — steps 13-15 (quality + export)"
```

---

## Task 7: Write article — conclusion and final polish
...
**Step 2: Final review — scan the entire article for:**
- Consistent formatting
- Correct command syntax
- Natural narrative flow
- No duplicate screenshot placeholders
- Proper heading hierarchy (h1 → h2 for each step)

**Step 3: Commit**

```bash
git add docs/case-studies/taskflow-tutorial.md
git commit -m "docs: complete TaskFlow tutorial with conclusion"
```

---

## Task 8: Create test checklist

**Files:**
- Create: `docs/plans/taskflow-test-checklist.md`

**Step 1: Write the checklist**

A condensed version of the tutorial for manual test execution. For each step:
- The exact command to run
- What to verify (expected pages, components, behavior)
...
```bash
git add docs/plans/taskflow-test-checklist.md
git commit -m "docs: add TaskFlow test execution checklist"
```
