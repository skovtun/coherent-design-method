    ...
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1">
          ...
          {/* Attribution footer — sits under the content area, not in
              the sidebar (where it competed with version/generated). */}
          <div className="mx-auto w-full max-w-[1280px] px-4 pb-8 lg:px-6 lg:pb-10">
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-border pt-5 text-[12px] text-muted-foreground">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-md border border-border bg-card px-3 py-1.5 font-mono text-[11.5px] text-muted-foreground outline-none transition-colors hover:border-foreground/30 hover:text-foreground"
              >
                ...
                <span>coherent-design-method</span>
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="text-muted-foreground/60"><path d="M7 17 17 7"/><path d="M7 7h10v10"/></svg>
              </a>
            </div>
          </div>
        </main>
